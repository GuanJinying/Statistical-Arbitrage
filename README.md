...
After the selection process, we first use ARMA model to modify the spread as we can transform X<sub>t</sub> - X<sub>t-1</sub> = (a - bX<sub>t</sub>)&tau; + &delta;\sqrt{n}&epsilon;<sub>t</sub>
